...
def corrupt_mnist() -> tuple[torch.utils.data.Dataset, torch.utils.data.Dataset]:
    ...
    train_images = torch.load("data/processed/train_images.pt", weight_only=True)
    train_target = torch.load("data/processed/train_target.pt", weight_only=True)
    test_images = torch.load("data/processed/test_images.pt", weight_only=True)
    test_target = torch.load("data/processed/test_target.pt", weight_only=True)
